...
namespace SangoUtils.AnchorEngines_Unity.Core.Utils
{
    internal static class Coroutines
    {
        ...
        /// <returns></returns>
        internal static IEnumerator WaitOneFrame(System.Action onCompleteCallback)
        {
            yield return null;
        ...
        /// <param name="onCompleteCallback">Callback</param>
        /// <returns></returns>
        internal static IEnumerator WaitFrames(int frames, System.Action onCompleteCallback)
        {
        ...
        /// <returns></returns>
        internal static IEnumerator WaitAfterSeconds(float seconds, System.Action onCompleteCallback)
        {
        ...
        /// <param name="onCompleteCallback"></param>
        /// <returns></returns>
        internal static IEnumerator WaitEndOfFrame(System.Action onCompleteCallback)
        {
        ...
        /// <param name="onCompleteCallback">Callback</param>
        /// <returns></returns>
        internal static IEnumerator WaitUntil(Func<bool> predicate, System.Action onCompleteCallback)
        {
